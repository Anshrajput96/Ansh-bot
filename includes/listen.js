module.exports = function ({ api, models }) {
    ...
    (async function () {
        ...
        try {
            logger(global.getText('listen', 'startLoadEnvironment'), '[ ansh Rajput ]');
    ...
    //FUNCTION WORKS AS IT'S NAME, CRE: ANSHU
    const monthToMSObj = {
        1: 31 * 24 * 60 * 60 * 1000,
        2: 28 * 24 * 60 * 60 * 1000,
        3: 31 * 24 * 60 * 60 * 1000,
